...
<div class="three_text" style="text-align:center;width:100%;">
  <p style="font-size:18px; color:#555555;">投稿者ID:<?=htmlspecialchars($param["id"]) ?></p>
  ...
  <a type="button" class="btn btn-outline-info" href="admin_poster_delete.php?id=<?php echo $param['id']; ?>"
