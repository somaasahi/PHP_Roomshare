...
<body>
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    ?>
    <div class="amain" style="height:1000px;">
...
<form action="" method="post">
    ...
    <div class="view_three_text">
      <input class="btn btn-outline-info" style="margin-bottom:60px;margin-left:100px;"
      type="submit" value="クリックして投稿!" onclick="return confirm('投稿しますか？')">
