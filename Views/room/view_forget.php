...
$error_login="";
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if($error_name==="" && $error_mail==="" && $error_tel==="") {
        ...
        $params = $room->view_pass_forget();

       if($params['bool'] == true){
           $_SESSION['form'] = $post;
           $_SESSION['update'] = 'ok';
           header('Location: view_pass_update.php');
           exit();
         }else{
           $error_login = "wrong";
         }
  ...
  <div class="formgroup" style="margin-bottom:30px;">
      <input id="forget" style="width:250px;" type="submit" type="button" class="btn btn-info" value="再設定画面へ"></td>
    </div>
