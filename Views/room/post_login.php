...
<div class="formgroup" style="margin-bottom:30px;">
    ...
    class="form-control"value="<?php if(isset($post['mail'])){echo htmlspecialchars($post['mail']);}?>" placeholder="mail">
</div>
...
<div class="formgroup" style="margin-bottom:30px;">
  ...
  <?php endif; ?>
      ...
      class="form-control" value="<?php if(isset($post['mail'])){echo htmlspecialchars($post['mail']);}?>" placeholder="password">
</div>
...
<div class="formgroup" style="margin-bottom:30px;">
<a href="post_register.php" type="button" class="btn btn-info" style="width:250px;">部屋を投稿するために新規登録</a>
</div>
      <a href="post_forget.php" type="button" class="btn btn-info" style="width:250px;">パスワードを忘れてしまった方</a>
</form>
